...
import personImg from '/image-avatar.png'
import { Logo } from './Logo';
import carrito from '/compras.png'
...
export default function NavBar() {
    const itemRenderer = (item, options) => {
        ...
        if (item.root) {
            return (
                ...
                <a className="flex align-items-center cursor-pointer px-3 py-2 overflow-hidden relative  p-ripple hover:surface-ground text-gray-500 text-[15px]" style={{ borderRadius: '2rem' }} onClick={(e) => options.onClick(e)}>
    ...
    const end = (
        <div className='flex'>
            <img src={carrito} alt="carrito de compras" className='w-auto h-[20px] pr-10 mt-2' />
            <Avatar image={personImg} shape="circle" className='w-[50px]' />
        </div>
    )
